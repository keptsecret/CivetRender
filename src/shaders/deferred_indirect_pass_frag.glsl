/*
 * Parts adapted from The Baking Lab
 * Like here: https://github.com/TheRealMJP/BakingLab/blob/1a043117506ac5b5bcade5c86d808485f3c70b12/BakingLab/SG.hlsl
 */
...
void main() {
    ...
    for (int idx = 0; idx < 8; idx++) {
        ...
        vec3 probeDir = normalize(probePos - worldPos);
...
in float roughness, in vec3 view, out vec3 irradiance, out vec3 specular) {
    ...
    for (int i = 0; i < SGCount; i++) {
        SG sg;
        sg.amplitude = texture(SGAmplitudes, vec2(probeIndex, i)).xyz;
